...
namespace SalesContextAPI.Core.Services.Standard
{
    public class ServiceBase<TEntity> : IServiceBase<TEntity> where TEntity : class, IIdentityEntity
    {
        protected readonly IBaseRepositoryAsync<TEntity> repository;

        public ServiceBase(IBaseRepositoryAsync<TEntity> repository)
        {
